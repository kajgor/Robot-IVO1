...
class RacConnection:
    ...
    def __init__(self):
        ...
        self.sink = Gst.ElementFactory.make("ximagesink", None)  # glimagesink(default)/gtksink/cacasink/autovideosink
    ...
    def gst_init_cam(self):
        ...
        self.player.add(avdec)
        self.player.add(self.vconvert)
        self.player.add(video_flip)
        self.player.add(self.sink)

        self.source.link(self.decoder)
        self.decoder.link(rtimer)
        rtimer.link(avdec)
        avdec.link(self.vconvert)
        self.vconvert.link(video_flip)
        video_flip.link(self.sink)
        # --- Gstreamer setup end ---
